                        ...
                        <div class="dropdown-menu dropdown-menu-rich dropdown-menu-left">
                            ...
                            <div class="dropdown-sheets">
                                ...
                                <div class="dropdown-sheet-item">
                                    <a href="{{ route('membres') }}" class="tile-wrapper"><span
                                            class="tile tile-lg bg-indigo"><i class="oi oi-people"></i></span> <span
                                            class="tile-peek">Membre</span></a>
                                </div><!-- /.dropdown-sheet-item -->
                                <!-- .dropdown-sheet-item -->
                                <div class="dropdown-sheet-item">
                                    <a href="{{ route('home') }}" class="tile-wrapper"><span
                                            class="tile tile-lg bg-teal"><i class="oi oi-fork"></i></span> <span
                                            class="tile-peek">Site</span></a>
                                </div><!-- /.dropdown-sheet-item -->
                ...
                <div class="dropdown d-none d-md-flex">
                    <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true"
                        ...
                        <span class="user-avatar user-avatar-md"><img
                                src="{{ asset('assets/admin/images/default.jpg') }}" alt=""></span>
                        <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">{{
                                ...
                                class="account-description">Admin</span></span></button> <!-- .dropdown-menu -->
