...
<section>
    <div class="container">
        ...
        <div class="title-style3 mb-2-3 mb-md-6 text-center wow fadeIn" data-wow-delay="100ms">
            <span>Sermons</span>
            <h2 class="h1 mb-0">Nos recents sermons</h2>
        </div>
        ...
        <div class="row g-xl-5 mt-n2-6">
                ...
                <article class="card card-style2 h-100">
                    <div class="card-img position-relative">
                        ...
                        <a href="#!" class="category rounded">{{ $p->subtitle=="adoration"?"Culte d'":"Culte de " }} {{ $p->subtitle??"Séminaire" }}</a>
                    </div>
                    <div class="card-body p-2-0 p-xl-2-4">
                        <span class="text-secondary mb-2 d-block font-weight-500">
                            {{\Carbon\Carbon::parse($p->date)->isoFormat('LLL')}}
                        </span>
                        <h3 class="h5 mb-4"><a href="{{ route('detail',['id'=>1]) }}">{{ $p->titre }}</a></h3>
